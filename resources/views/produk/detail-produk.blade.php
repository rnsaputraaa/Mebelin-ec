        ...
        <div class="container mx-auto px-6 lg:px-16 max-w-7xl pt-24">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-3">
                        <button class="w-7xl mt-10 bg-[#BF654B] text-white py-3 px-6 rounded-lg font-medium hover:bg-orange-900">
                            Tambah keranjang
                        </button>
                        <button class="w-7xl border border-[#BF654B] text-[#BF654B] py-3 px-6 rounded-lg font-medium hover:bg-gray-100">
                            Beli Sekarang
                        </button>
                    </div>
                </div>
