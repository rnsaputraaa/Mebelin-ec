...
@section('content')
    <div class="container mx-auto p-4 pt-24 mt-0 md:pt-28">
        <button id="filter-toggle"
            class="w-full mb-4 bg-[#BF654B] text-white py-2 rounded-md flex items-center justify-center md:hidden">
            ...
            <div class="flex-1">
                ...
                <div class="flex justify-end mt-8">
                    <nav class="flex items-center space-x-1">
                        ...
                        <a href="#"
                            class="px-3 py-2 text-gray-700 hover:text-gray-900 hover:bg-gray-100 rounded-md">2</a>
                        <a href="#"
                            class="px-3 py-2 text-gray-700 hover:text-gray-900 hover:bg-gray-100 rounded-md">3</a>
                        <a href="#"
                            class="px-3 py-2 text-gray-700 hover:text-gray-900 hover:bg-gray-100 rounded-md">4</a>
                        <a href="#"
                            class="px-3 py-2 text-gray-700 hover:text-gray-900 hover:bg-gray-100 rounded-md">5</a>
                        <a href="#"
                            class="px-3 py-2 text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-md">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
