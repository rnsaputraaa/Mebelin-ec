                ...
                <div class="w-full md:w-1/2 flex items-center justify-center">
                    <div class="w-full max-w-sm p-8 rounded-3xl shadow-lg" style="background-color: #BAA388;">
                        <div class="text-center mb-8">
                            ...
                            <p class="text-white text-sm mt-2">Sudah Punya Akun? <a href="{{ route('login') }}"
                                    class="text-blue-900 underline hover:text-white">Masuk</a></p>
                        </div>
                        ...
                        <form method="POST" action="{{ route('register') }}" class="space-y-6">
                            ...
                            <button type="submit"
                                class="w-full bg-white text-gray-900 font-semibold py-3 rounded-lg hover:bg-gray-50 transition duration-300 shadow-sm mt-6">
                                Create account
                            </button>
                            ...
                            <button type="button"
                                class="w-full bg-white text-gray-900 font-semibold py-3 rounded-lg hover:bg-gray-50 transition duration-300 flex items-center justify-center space-x-2 shadow-sm">
