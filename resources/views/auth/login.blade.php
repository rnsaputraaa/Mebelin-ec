                ...
                <div class="w-full md:w-1/2 flex items-center justify-center">
                    <div class="w-full max-w-sm p-8 rounded-3xl shadow-lg" style="background-color: #BAA388;">
                        <div class="text-center mb-8">
                            ...
                            <p class="text-white text-sm mt-2">Belum punya akun? <a href="{{ route('register') }}"
                                    class="text-blue-900 underline hover:text-white">Daftar</a></p>
                        </div>
                        ...
                        <form method="POST" action="{{ route('login') }}" class="space-y-6">
                            ...
                            <div class="text-right">
                                @if (Route::has('password.request'))
                                    <a class="text-gray-900 text-sm hover:text-white"
                            ...
                            <button type="submit"
                                class="w-full bg-white text-gray-900 font-semibold py-3 rounded-lg shadow-sm">
                                Login
                            </button>
                            ...
                            <button type="button"
                                class="w-full bg-white text-gray-800 font-semibold py-3 rounded-lg flex items-center justify-center space-x-2 shadow-md">
